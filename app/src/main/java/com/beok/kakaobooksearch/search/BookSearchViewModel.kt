...
class BookSearchViewModel @Inject constructor(
    ...
    private val _document = MutableLiveData<List<com.beok.kakaobooksearch.search.vo.DocumentVO>>()
    val document: LiveData<List<com.beok.kakaobooksearch.search.vo.DocumentVO>> get() = _document
