...
internal interface BookSearchAPI {
    ...
    ): com.beok.kakaobooksearch.search.data.entity.BooksResponse
    ...
    class Fake : BookSearchAPI {
        ...
        override suspend fun searchBookByTitle(
            ...
            com.beok.kakaobooksearch.search.data.entity.BooksResponse(
                documents = listOf(
                    com.beok.kakaobooksearch.search.data.entity.DocumentsItem(
                ...
                meta = com.beok.kakaobooksearch.search.data.entity.Meta(
                    totalCount = 15,
                    isEnd = false,
                    pageableCount = 13
                )
